...
def normel_score(tab,path,notebook,question_page,question_func,home,database,user_id):
    ...
    def show_result():
        ...
        ctk.CTkLabel(title_frame,text="",image=tab.logo,font=("impact",30)).grid(row=0,column=1)
        ctk.CTkLabel(title_frame,text=subject.get().upper(),wraplength=160,font=("impact",30),
                     width=80,fg_color="#0A082D",text_color="white").grid(row=0,column=3,sticky="w")
        ...
        ctk.CTkLabel(result_frame,text = "GREAT!",font=("roboto",35,"bold"),text_color="white").grid(row=0,column=0,pady=20,padx=15)
        ctk.CTkLabel(result_frame,text = "You'll Nail It Next Time!",font=("roboto",27,"bold"),text_color="white").grid(row=1,column=0,padx=15)
        ctk.CTkLabel(result_frame,text = f"{items[0][0]}",font=("roboto",40,"bold"),text_color="white").grid(row=2,column=0,pady=20)
        ...
        temp_user_frame.grid(row=0,column=0,padx=50,pady=3)
        ...
        temp_score_frame = ctk.CTkFrame(score_frame,fg_color="blue",width=330,height=50,corner_radius=15)
        temp_score_frame.grid(row=0,column=0,pady=1,padx=40)
        
        ctk.CTkLabel(temp_score_frame,text="Your Score",font=("calibri",21,"bold"),text_color="white").grid(row=0,column=0,padx=10,pady=7)
        ctk.CTkLabel(temp_score_frame,text=f"{items[0][0]}/{items[0][1]}",font=("calibri",23,"bold"),height=40,corner_radius=20,text_color="white").grid(row=0,column=1,padx=8)
