...
def select_sub_leaderbaord(tab,notebook,leader_board,path,home,database,user_id,leaderboard_func):
    ...
    def select_python():
        ...
        cursor.execute("insert into leaderboard_selection (user_id, subject) values(?,?)",(user_id.get(),"python"))
        connection.commit()
        connection.close()
        leaderboard_func()
        notebook.select(leader_board)
    ...
    def select_java():
        ...
        cursor.execute("delete from score")
        cursor.execute("delete from leaderboard_selection")
        cursor.execute("insert into leaderboard_selection (user_id, subject) values(?,?)",(user_id.get(),"java"))
        connection.commit()
        connection.close()
        leaderboard_func()
        notebook.select(leader_board)
    ...
    def select_internet():
        ...
        cursor.execute("delete from score")
        cursor.execute("delete from leaderboard_selection")
        cursor.execute("insert into leaderboard_selection (user_id, subject) values(?,?)",(user_id.get(),"Internet Tech"))
        connection.commit()
        connection.close()
        leaderboard_func()
        notebook.select(leader_board)
    ...
    def select_accounts():
        ...
        cursor.execute("delete from score")
        cursor.execute("delete from leaderboard_selection")
        cursor.execute("insert into leaderboard_selection (user_id, subject) values(?,?)",(user_id.get(),"Accounting & Finance"))
        connection.commit()
        connection.close()
        leaderboard_func()
        notebook.select(leader_board)
    ...
    def select_information():
        ...
        cursor.execute("delete from score")
        cursor.execute("delete from leaderboard_selection")
        cursor.execute("insert into leaderboard_selection (user_id, subject) values(?,?)",(user_id.get(),"Information System"))
        connection.commit()
        connection.close()
        leaderboard_func()
        notebook.select(leader_board)
