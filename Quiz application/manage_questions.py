...
def manage_question(tab,notebook,path,database,admin_panel):
    ...
    ctk.CTkLabel(nav,text="MANAGE QUESTIONS",font=("impact",35),text_color="white").grid(row=0,column=1,pady=10)
    ...
    def remove(quiz_id,table):
            
            connection = sqlite3.connect(database)
            cursor = connection.cursor()
            cursor.execute(f"delete from {table.get()} where id=?",(quiz_id,))
            connection.commit()
            connection.close()
            run("")
    ...
    def run(event):
        ...
        table = tk.StringVar(value="python_easy")
        if sub_type.get()=="Python" and  sub_level.get()=="Easy":
            table.set("python_easy")

        elif sub_type.get()=="Python" and  sub_level.get()=="Medium":
            table.set("python_medium")

        elif sub_type.get()=="Python" and  sub_level.get()=="Hard":
            table.set("python_hard")

        elif sub_type.get()=="Java" and  sub_level.get()=="Easy":
            table.set("java_easy")

        elif sub_type.get()=="Java" and  sub_level.get()=="Medium":
            table.set("java_medium")

        elif sub_type.get()=="Java" and  sub_level.get()=="Hard":
            table.set("java_hard")

        elif sub_type.get()=="Internet Tech" and  sub_level.get()=="Easy":
            table.set("internet_tech_easy")

        elif sub_type.get()=="Internet Tech" and  sub_level.get()=="Medium":
            table.set("internet_tech_medium")

        elif sub_type.get()=="Internet Tech" and  sub_level.get()=="Hard":
            table.set("internet_tech_hard")

        elif sub_type.get()=="Accounting & Finance" and  sub_level.get()=="Easy":
            table.set("accounting_easy")

        elif sub_type.get()=="Accounting & Finance" and  sub_level.get()=="Medium":
            table.set("accounting_medium")

        elif sub_type.get()=="Accounting & Finance" and  sub_level.get()=="Hard":
            table.set("accounting_hard")

        elif sub_type.get()=="Information System" and  sub_level.get()=="Easy":
            table.set("information_easy")

        elif sub_type.get()=="Information System" and  sub_level.get()=="Medium":
            table.set("information_medium")

        elif sub_type.get()=="Information System" and  sub_level.get()=="Hard":
            table.set("information_hard")

        lst = []
        connection=sqlite3.connect(database)
        cursor = connection.cursor()
        cursor.execute(f"select id from {table.get()}")
        ids = cursor.fetchall()
        for i in ids:
            lst.append(i[0])
        connection.close()
        ...
        ctk.CTkLabel(quize_frames,text="Quize Id",height=40,fg_color="#2A3650",
                     text_color="white",font=("roboto",19,"bold"),corner_radius=15).grid(row=0,column=0,sticky="w",padx=50)
        ctk.CTkLabel(quize_frames,text="Question",height=40,fg_color="#2A3650",
                     text_color="white",font=("roboto",19,"bold"),corner_radius=15).grid(row=0,column=1,sticky="w",padx=340)
        ...
        def show_questions():
            ...
            for quiz_id in lst:
                ...
                connection = sqlite3.connect(database)
                cursor = connection.cursor()
                cursor.execute(f"select quize from {table.get()} where id=?",(quiz_id,))
                ...
                ctk.CTkLabel(quize_frames,text=quiz_id,
                             text_color="black",font=("roboto",20,"bold"),fg_color="white").grid(row=0,column=0,sticky="w",padx=90)
                ctk.CTkLabel(quize_frames,text=question[0],text_color="black",
                             font=("roboto",20,"bold"),wraplength=750,fg_color="white").grid(row=0,column=1,sticky="we",pady=12)
                ctk.CTkButton(quize_frames,text="Remove",fg_color="#DB0A41",height=35,command=partial(remove,quiz_id,table),
    ...
    ctk.CTkLabel(slect_container,text="Select Level: ",text_color="black",font=("calibri",19)).grid(row=2,column=0,padx=15,pady=15,sticky="e")
    select_level = ctk.CTkComboBox(slect_container,height=35,variable=sub_level,border_color="#0A082D",button_color="#DB0A41",fg_color="white",
